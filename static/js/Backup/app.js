...
App.Impressao = (function () {
  ...
  async function popularFiltros() {
    // Popular clientes
    const clienteSel = document.getElementById('filter-cliente');
    if (clienteSel) {
      try {
    ...
    // Popular parceiros
    const parceiroSel = document.getElementById('filter-parceiro');
    if (parceiroSel) {
      try {
    ...
    // Popular máquinas
    const maquinaSel = document.getElementById('filter-maquina');
    if (maquinaSel) {
      try {
  ...
  async function init() {
    ...
    // TODO: bind toolbar events, fetch and render OIs, etc.
    // Example: bindToolbar(); fetchList();
  }
